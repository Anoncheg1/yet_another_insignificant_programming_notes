...
higher - lower
| Speed Class       |  10 |  10 |  10 |  10 |  6 | 4 | 2 |
| UHC CLass         |   3 |   1 |   3 |   1 |    |   |   |
| Video Speed Class | V90 | v60 | V30 | V10 | V6 |   |   |
...
- test: flashrom -p linux_spi:dev=/dev/spidev0.0,spispeed=2000
- flashrom -p linux_spi:dev=/dev/spidev0.0,spispeed=1500 -c "W25Q64.V" -r factory1.rom
- flashrom -p linux_spi:dev=/dev/spidev0.0,spispeed=2000 -c "W25Q64.V" -r factory2.rom
- flashrom -p linux_spi:dev=/dev/spidev0.0,spispeed=2500 -c "W25Q64.V" -r factory3.rom
...
- tvservice - HDMI video and audio.
  ...
  - -e, --explicit="Group Mode Drive" Power on the HDMI with the specified settings Group can be one of CEA, DMT,
    CEA_3D_SBS, CEA_3D_TB, CEA_3D_FP, CEA_3D_FS. Mode is one of the modes returned from the -m, --modes option. Drive
...
4. ssh pi@[raspberrypi_ip_address]
*** increase swap
